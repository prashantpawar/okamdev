...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      $sql = 'SELECT * FROM ok_relevancies ' . $where_clause . $limit_clause;
   ...
   function retrieve_by_pkey($idField) {
      ...
      $query = $this->db->query("SELECT * FROM ok_relevancies WHERE id = '$idField' LIMIT 1");
   ...
   function add( $data ) {
      ...
      $sql = $this->db->insert_string('ok_relevancies', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      // Build up the SQL query string
      $where = "id = $keyvalue";
      $sql = $this->db->update_string('ok_relevancies', $data, $where);
   ...
   function delete_by_pkey($idField)
   {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $query = $this->db->query("DELETE FROM ok_relevancies WHERE id = '$idField' ");
