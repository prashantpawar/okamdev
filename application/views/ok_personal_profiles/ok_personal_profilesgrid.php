<?
   ...
   $modify_url = site_url('ok_personal_profiles/modify/');
   $delete_url = site_url('ok_personal_profiles/delete/');
   $add_url    = site_url('ok_personal_profiles/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmok_personal_profiles'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing ok_personal_profiles values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <?
         $i = 0;
         foreach ($ok_personal_profiles_list as $ok_personal_profiles) {
            $i++;
            if (($i%2)==0) { $bgColor = "#FFFFFF"; } else { $bgColor = "#C0C0C0"; }
      ?>
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$ok_personal_profiles["id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$ok_personal_profiles["id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $ok_personal_profiles['id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $ok_personal_profiles['user_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $ok_personal_profiles['location']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
